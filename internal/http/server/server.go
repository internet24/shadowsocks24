...
import (
	...
	"github.com/internet24/shadowsocks24/internal/http/handlers"
	"github.com/internet24/shadowsocks24/internal/http/handlers/v1"
	internalMw "github.com/internet24/shadowsocks24/internal/http/middleware"
	"github.com/internet24/shadowsocks24/internal/http/validator"
...
func (s *Server) Run() {
	...
	g2.POST("/tools/outline-import", v1.OutlineImport(s.coordinator))
